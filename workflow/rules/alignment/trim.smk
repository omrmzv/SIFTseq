...
rule trim:
	...
	shell:
		"""
		prep_type={params.prep_and_seq_type[1]}
		seq_type={params.prep_and_seq_type[2]}
		bash workflow/scripts/trim/BBDUK_WRAP_v2.sh --bbduk_path={BBDUK} --seq_type=$seq_type --prep_type=$prep_type \
